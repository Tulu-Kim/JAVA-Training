...
class AnalogueClock2 extends Frame implements ItemListener, Runnable {
...
//메뉴 셋팅//
	...
	private String imgFile = "images/Clock1.jpg";// 이미지 주소 초기호
...
// if(beacon.getState()) {
	...
	public static void main(String[] args) {
		AnalogueClock2 clock = new AnalogueClock2();
