...
public class Ex03 {
	...
	System.out.println("byte(범위)="+a_min+"~"+a_max);
	System.out.println("char(범위)="+b_min+"~"+b_max);
	System.out.println("int(범위)="+c_min+"~"+c_max);
	System.out.println("float(범위)="+d_min+"~"+d_max);
	}
